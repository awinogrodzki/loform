...
describe('FormInput', function () {
    ...
    it('should update input descriptor on change', function () {
        var change;
        enzyme_1.shallow(React.createElement(FormInput_1.FormInput, __assign({}, mockDescriptor, { formService: formService, formEventEmitter: formEventEmitter }), function (_a) {
