...
export declare type InputValue = any;
...
export declare type GenericInputProps<T extends InputProps> = T & {
...
export declare type FormValueType = InputValue | InputValue[] | FormValues;
...
export declare type FormErrorsMap = Map<string, string[]>;
export declare type ValidationStrategy = (errors: FormErrorsMap, prevErrors: FormErrorsMap) => FormErrorsMap;
export declare type InputValidationStrategy = (input: InputDescriptor, errors: FormErrorsMap, prevErrors: FormErrorsMap) => FormErrorsMap;
