...
export var PasswordInput = function (_a) {
    var id = _a.id, className = _a.className, name = _a.name, placeholder = _a.placeholder, _b = _a.onChange, onChange = _b === void 0 ? function () { } : _b, _c = _a.value, value = _c === void 0 ? undefined : _c;
